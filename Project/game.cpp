...
printf("   %c  ",127);printf("You are given 5 tries to guess the word.\n");
...
printf("   ____________________________\n\n");
printf("\n\n\n   Team Members : ");
printf("\n    ______________________________\t\t\t\t\tSubject : COMP 101");
...
printf("\n   | Shreejan Dahal (11)          |");
printf("\n   |                              |");
printf("\n   | Rupesh Neupane (47)          |\t\t\t\t\tLecturer :   Pranita Karki");
printf("\n   |                              |\t\t\t\t\tDepartment : Computer Science & Computer Engineering");
printf("\n   | Romanch Neupane (48)         |\t\t\t\t\t             Kathmandu University School of Engineering");
...
int Random_Generator(int gam_choice){
	...
	{
		static char word_group_2[][30] = {"politics","parliament","government","kpoliop"/*replace this word, not remove*/,"democracy","majority","regime","court","bill","congress","maoist","constituent","election","register","referendum","saablaighoptoparerahannuparne"/*remove this word, not replace*/};
		srand(time(NULL));
